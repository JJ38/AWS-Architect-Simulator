...
export const services: Record<string, Service> = {
    ...
    "API Gateway V2": { name: 'API Gateway V2', description: 'API Gateway V2', terraformType: 'resource', providerType: 'aws_apigatewayv2_api', icon: 'serviceIcons/Res_Amazon-API-Gateway_Endpoint_48.svg', image: 'serviceImages/Arch_Amazon-API-Gateway_64.svg'}
}
